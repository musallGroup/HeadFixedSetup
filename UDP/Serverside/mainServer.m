...
while true
    ...
    if u.NumDatagramsAvailable > 0
        ...
        switch mode
            case 'start_session'
                [paradigm, setting , subjectID, stage,photometry, optogenetic,change_stage] = processDatagram(message_info, []);
                message = sprintf('paradigm= %s,setting= %s,subjectID= %s,stage= %s,photometry= %s,optogenetic=%s,change_stage=%s', ...
                    paradigm, setting, num2str(subjectID),stage,photometry,optogenetic,change_stage);
